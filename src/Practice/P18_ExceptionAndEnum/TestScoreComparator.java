...
public class TestScoreComparator {
	public static void main(String[] args) {
		...
		Comparator mathComp = ScoreComparator.valueOf("MathComparator");
		Comparator engComp = ScoreComparator.valueOf("EnglishComparator");
		Comparator cnComp = LambdaScoreComparator.valueOf("ChineseComparator");
